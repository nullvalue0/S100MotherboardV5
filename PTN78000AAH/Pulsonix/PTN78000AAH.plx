...
(library Library_1
	...
	(patternDef "EUS(R-PDSS-T5)" (originalName "EUS(R-PDSS-T5)")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 9.353, -6.688) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt 0 0) (pt 18.92 0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 18.92 0) (pt 18.92 -12.57) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 18.92 -12.57) (pt 0 -12.57) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 0 -12.57) (pt 0 0) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "PTN78000AAH" (originalName "PTN78000AAH") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		...
		(compPin "2" (pinName "VI") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "N/C") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "VO_ADJUST") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/ptn78000a.pdf")
	)
